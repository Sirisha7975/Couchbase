...
public class LearnCouchbaseController {	
    ...
    @RequestMapping(value = "/addRecordIntoBucket", method = RequestMethod.POST)
    public Airport addRecordIntoBucket(@RequestBody Airport body) {
    	Airport result = learnCBService.addAirport(body);
    	    System.out.println("LearnCouchbaseController:addRecordIntoBucket() - Returned Results = "+result.toString());
